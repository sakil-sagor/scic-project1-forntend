      ...
      <div className="px-2 md:px-4 py-6 border shadow-2xl">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <label htmlFor={`my_modal_${_id}`}>
              <i className="far fa-trash-alt hover:text-red-800 border px-4 py-2 text-xl hover:border-red-800 cursor-pointer transition duration-500 rounded"></i>
            </label>
          </div>
        ...
        <div className="modal">
          <div className="modal-box">
            <p className="py-4 text-xl text-red-600 text-center font-bold">
              Do you want to remove this product!
            </p>
            <div className="modal-action">
              <label htmlFor={`my_modal_${_id}`} className="btn py-1">
                No
              </label>
              <label
